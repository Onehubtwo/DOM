...
function add(a){
       ...
       a.innerHTML=r 
       total.innerHTML=parseFloat(a.parentElement.parentElement.children[2].children[1].innerHTML)+ parseFloat(total.innerHTML) 
...
function minus(a){
        ...
        if (r>0){
        a.innerHTML=r-1
        total.innerHTML=parseFloat(total.innerHTML) - parseFloat(a.parentElement.parentElement.children[2].children[1].innerHTML)
        }
